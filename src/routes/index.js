...
import { userRegistrationValidator, userLoginValidator, updatePasswordValidator } from '../validators/userValidator';
...
router.post('/register', userRegistrationValidator, validate, UserController.register);
router.post('/login', userLoginValidator, validate, UserController.login);
router.post('/password-change', updatePasswordValidator, validate, UserController.changePassword);
