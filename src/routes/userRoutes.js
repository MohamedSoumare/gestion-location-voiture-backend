...
router.post('/users/register', userRegistrationValidator, validate, registerUser);
...
router.post('/users/password-change', authMiddleware, updatePasswordValidator, validate, changePassword);
...
router.put('/users/update-role', authMiddleware, checkRole('admin'), updateUserRole);
